...
#define GUN ('#' | COLOR_PAIR(103))

typedef enum {PLAYER = '8', ZOMBIE = 'z', FZOMBIE = 'f', ITEM = '!', WALL = '#', GROUND = '.', POND = '~', ROCK = '@', BULLET_CHAR = '*'} type;
